...
CREATE TABLE stocks(Negocio_id integer ,  producto_id integer , stock_producto integer , proveedor_id integer , precio integer );
...
CREATE TABLE ventas(num_venta integer , negocio_id integer, fecha timestamp);
